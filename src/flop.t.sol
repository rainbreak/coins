...
contract Guy {
    Flopper fuss;
    function Guy(Flopper fuss_) public {
        fuss = fuss_;
        ...
        public returns (bool)
    {
        ...
        return fuss.call(sig, id, lot, bid);
    }
    function try_deal(uint id)
        public returns (bool)
    {
        bytes4 sig = bytes4(keccak256("deal(uint256)"));
        return fuss.call(sig, id);
    }
}
...
contract WarpFlop is Flopper {
    ...
    function WarpFlop(address pie_, address gem_) public Flopper(pie_, gem_) {}
}
